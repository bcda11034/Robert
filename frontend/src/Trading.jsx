...
import Futures from "./Trading/Futures";
...
const TradingApp = () => {
  ...
  useEffect(() => {
    async function fetchFuturesCurrentPrices() {
      ...
      const futuresPriceResponse = await api.post(
    ...
    async function fetchUserData() {
      try {
        ...
        const positionsResponse = await api.post(
    ...
    function processPositionsData(data) {
        ...
        data.spotPositions.forEach((position) => {
          ...
          if (position.orderLimit == 1) {
            ...
            if (
              ...
              fetch(`${process.env.REACT_APP_API_URL}/api/trade/startTrade`, {
                method: "POST",
                headers: {
                  Authorization: "Bearer " + localStorage.getItem("token"),
                  "Content-Type": "application/json",
      ...
      if (spotCurrentPrices.length) {
        ...
        //---------------------------------------------------------
        fetch(`${process.env.REACT_APP_API_URL}/api/updateValue`, {
          method: "POST",
          headers: {
            Authorization: "Bearer " + localStorage.getItem("token"),
            "Content-Type": "application/json",
  ...
  function saveTPSL(position) {
    ...
    fetch(`${process.env.REACT_APP_API_URL}/api/position/saveTPSL`, {
      method: "POST",
      headers: {
        Authorization: "Bearer " + localStorage.getItem("token"),
        "Content-Type": "application/json",
  ...
  function closeSpotPosition(position) {
    ...
    fetch(`${process.env.REACT_APP_API_URL}/api/position/closeSpotPosition`, {
      method: "POST",
      headers: {
        Authorization: "Bearer " + localStorage.getItem("token"),
        "Content-Type": "application/json",
  ...
  function partialClose() {
    ...
    if (percent == 100) {
      ...
      fetch(`${process.env.REACT_APP_API_URL}/api/partialClosePosition`, {
        method: "POST",
        headers: {
          Authorization: "Bearer " + localStorage.getItem("token"),
          "Content-Type": "application/json",
  ...
  function closeFuturesPosition(position, reason) {
    fetch(`${process.env.REACT_APP_API_URL}/api/position/closeFuturesPosition`, {
      method: "POST",
      headers: {
        Authorization: "Bearer " + localStorage.getItem("token"),
        "Content-Type": "application/json",
